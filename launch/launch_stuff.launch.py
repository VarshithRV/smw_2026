...
def launch_setup(context, *args, **kwargs):
    ...
    so3_deconing_node = Node(
        package="smw_2026",
        executable="so3_deconing",
        name="so3_deconing",
        output="screen",
        parameters=[
            robot_description,
    ...
    left_preaction_server = Node(
        ...
        parameters=[
            ...
            {
                "planning_group": "left_ur16e",
                "shoulder_pan": 0.6327896118164062,
                "shoulder_lift": -1.530074381535389,
                "elbow": -2.6847221851348877,
                "wrist_1": -0.4980843824199219,
                "wrist_2": -1.5689991156207483,
                "wrist_3": -2.2041104475604456,
                "side": "left",
                "endeffector_link": "left_tool0",
                "side": "left",
            },
