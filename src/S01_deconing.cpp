...
#include "smw_2026/S01_deconing_waypoints.hpp"
...
int main(int argc, char** argv){
    ...
    auto execute_service_callback = [wp_entry_point,node_,left_gripper_on,left_gripper_off,left_gripper_neutral](std_srvs::srv::Trigger::Request::SharedPtr req, std_srvs::srv::Trigger::Response::SharedPtr res){
        ...
        if(is_joint_state_close(left_start_joint_state,left_preaction_state)){
            ...
            left_waypoints.insert(left_waypoints.end(),{waypoints.left_wp0.pose,waypoints.left_wp1.pose,waypoints.left_wp2.pose});
            ...
            left_waypoints.insert(left_waypoints.end(),{waypoints.left_wp2.pose});
        ...
        auto left_twist_cone_future = wp_entry_point->async_start_execute_waypoints_cubic(left_twist_cone,std::vector<double>{3},0.3,0.0,"left");
        wp_entry_point->block_till_response_execute_cubic_trajectory(left_twist_cone_future,15s);
        ...
        offset_position(waypoints.right_wp7.pose,std::vector<double>{-0.05,0.0,-0.02});
        ...
        auto right_back_future = wp_entry_point->async_start_execute_waypoints_cubic(right_back,std::vector<double>{1.5,1.5,1.5,1.5},0.3,0.1,"right"); 
        
        wp_entry_point->block_till_response_execute_cubic_trajectory(left_clear_future,15s);
